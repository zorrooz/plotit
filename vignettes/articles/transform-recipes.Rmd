...
> **本页解决什么问题**：Data-shaped recipes before plotting: pivots, rolling, summaries.
> **前置**：已完成 [gallery-composing](articles/gallery-composing.html)

> **下一步**：→ [use-case-bioinformatics](articles/use-case-bioinformatics.html)
