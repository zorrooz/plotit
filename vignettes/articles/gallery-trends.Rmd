...
> **本页解决什么问题**：Show change over time: lines, areas, step and date axes.
> **前置**：已完成 [gallery-coordinates](articles/gallery-coordinates.html)

> **下一步**：→ [gallery-matrix](articles/gallery-matrix.html)
