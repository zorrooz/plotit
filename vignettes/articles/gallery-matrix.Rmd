...
> **本页解决什么问题**：Matrix heatmaps, correlation matrices and annotated heatmaps.
> **前置**：已完成 [gallery-trends](articles/gallery-trends.html)

> **下一步**：→ [gallery-proportions](articles/gallery-proportions.html)
