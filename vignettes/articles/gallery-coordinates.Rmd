---
title: "Gallery: Time, Polar & Coordinates"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Gallery: Time, Polar & Coordinates}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **本页解决什么问题**：Polar, flipped, zoomed and fixed-aspect coordinate systems.
> **前置**：已完成 [gallery-relationships](articles/gallery-relationships.html)

> **下一步**：→ [gallery-trends](articles/gallery-trends.html)
...
`mark_bar()` with a constant x plus `project_polar(theta = "y")`: the
stacked bars wrap into sectors (the G2 "stack-on-a-circle" trick).
