---
title: "Gallery: Proportions"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Gallery: Proportions}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **本页解决什么问题**：Part-to-whole views: stacked bars and polar proportions.
> **前置**：已完成 [gallery-matrix](articles/gallery-matrix.html)

> **下一步**：→ [gallery-geo](articles/gallery-geo.html)
