...
> **本页解决什么问题**：Publication-quality figures: canvas, fonts, export.
> **前置**：已完成 [use-case-bioinformatics](articles/use-case-bioinformatics.html)

> **下一步**：→ [philosophy](articles/philosophy.html)
