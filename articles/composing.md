...
#>  .. $ title     : chr "Iris Dataset Overview"
#>  .. $ subtitle  : NULL
#>  .. $ caption   : NULL
#>  .. $ tag_levels: NULL
```
...
#>  .. $ axes   : chr "collect"
#>  @ annotations:List of 4
#>  .. $ title     : chr "Sepal vs Petal Measurements"
#>  .. $ subtitle  : NULL
#>  .. $ caption   : NULL
#>  .. $ tag_levels: NULL
```
...
#>  .. $ axes   : chr "keep"
#>  @ annotations:List of 4
#>  .. $ title     : chr "Comparison of Iris Measurements"
#>  .. $ subtitle  : NULL
#>  .. $ caption   : NULL
#>  .. $ tag_levels: chr "A"
```
...
#>  .. $ heights: num [1:2] 1 4
#>  @ annotations:List of 4
#>  .. $ title     : chr "Iris Sepal Measurements with Marginal Distributions"
#>  .. $ subtitle  : NULL
#>  .. $ caption   : NULL
#>  .. $ tag_levels: NULL
```
...
#>  .. $ axes   : chr "keep"
#>  @ annotations:List of 4
#>  .. $ title     : chr "Iris Dataset: Two Views"
#>  .. $ subtitle  : NULL
#>  .. $ caption   : chr "Anderson's Iris Data, 1935"
#>  .. $ tag_levels: NULL
```
