...
> **plotit 1.0.0** — 声明式管道 API 表面（plotit/encode、mark_*/scale_*/layout_*/compose_*、
> style/export）按 1.0 契约维护。次版本仍可能微调默认值与文档；问题请在 GitHub 反馈。
...
含 Get Started、Gallery（意图导向图例）、Advanced（组合/关系布局/扩展）与 API 系统页，
见站点 **Articles** 菜单。
